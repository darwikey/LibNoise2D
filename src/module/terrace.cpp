...
void Terrace::AddControlPoint (NOISE_REAL value)
{
...
int Terrace::FindInsertionPos (NOISE_REAL value)
{
  int insertionPos;
...
NOISE_REAL Terrace::GetValue (NOISE_REAL x, NOISE_REAL y) const
{
  ...
  NOISE_REAL value0 = m_pControlPoints[index0];
  NOISE_REAL value1 = m_pControlPoints[index1];
  NOISE_REAL alpha = (sourceModuleValue - value0) / (value1 - value0);
  if (m_invertTerraces) {
    alpha = 1.0f - alpha;
...
void Terrace::InsertAtPos (int insertionPos, NOISE_REAL value)
{
  ...
  // that array.
  NOISE_REAL* newControlPoints = new NOISE_REAL[m_controlPointCount + 1];
...
void Terrace::MakeControlPoints (int controlPointCount)
{
  ...
  NOISE_REAL terraceStep = 2.0f / ((NOISE_REAL)controlPointCount - 1.0f);
  NOISE_REAL curValue = -1.0;
