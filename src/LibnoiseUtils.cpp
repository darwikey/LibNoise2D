...
void WriterTER::WriteDestFile()
{
    ...
    noise::uint16 width = static_cast<noise::uint16>(m_pSourceNoiseMap->GetWidth());
    noise::uint16 height = static_cast<noise::uint16>(m_pSourceNoiseMap->GetHeight());
...
noise::utils::Color RendererImage::CalcDestColor(const noise::utils::Color& sourceColor,
	const noise::utils::Color& backgroundColor, double lightValue) const
{
...
noise::utils::Color RendererNormalMap::CalcNormalColor(double nc, double nr, double nu,
